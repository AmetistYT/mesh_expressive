...
[![Compose](https://img.shields.io/badge/Jetpack_Compose-Material3_Expressive-4285F4.svg?style=flat&logo=jetpackcompose)](https://developer.android.com/jetpack/compose)
[![Zero Trackers](https://img.shields.io/badge/Trackers-0%20(Pure)-00C853.svg?style=flat&logo=shield)](https://github.com/AmetistYT)
...
- 🛡️ **0 трекеров и 100% приватность**: Полностью вырезаны все встроенные модули слежки официального клиента:
...
Готовый установочный файл находится в репозитории:
- [📥 Скачать mesh-expressive-v1.2.0.apk](apk/mesh-expressive-v1.2.0.apk)
